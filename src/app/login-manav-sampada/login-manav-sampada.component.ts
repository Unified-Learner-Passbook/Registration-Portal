...
@Component({
  selector: 'app-login-manav-sampada',
  templateUrl: './login-manav-sampada.component.html',
  styleUrls: ['./login-manav-sampada.component.scss']
})
export class LoginManavSampadaComponent implements OnInit {
  baseUrl: string;
  featureList = [
