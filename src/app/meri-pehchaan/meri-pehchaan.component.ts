...
@Component({
  selector: 'app-meri-pehchaan',
  templateUrl: './meri-pehchaan.component.html',
  styleUrls: ['./meri-pehchaan.component.scss']
})
export class MeriPehchaanComponent implements OnInit {
  baseUrl: string;
  featureList = [
